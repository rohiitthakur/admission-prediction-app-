...
clf = joblib.load("clf_model.pkl")  # Save your model using joblib.dump(clf, 'clf_model.pkl')

# UI for user input
st.title("Lead Admission Prediction")
st.write("Enter lead details to predict the probability of admission")
...
lead_source = st.selectbox("Lead Source", ['organic', 'Referral', 'Paid Leads',])  # Update categories
...
course_interested = st.selectbox("Course Interested", ['MBA Online', 'BBA', ...])
